...
class V1alpha1CronWorkflowStatus(object):
    ...
    """
    openapi_types = {
        'active': 'list[kubernetes.client.models.V1ObjectReference]',
        'last_scheduled_time': 'kubernetes.client.models.V1Time'
    }
    ...
    def active(self):
        ...
        :rtype: list[kubernetes.client.models.V1ObjectReference]
        """
        return self._active
    ...
    def active(self, active):
        ...
        :type: list[kubernetes.client.models.V1ObjectReference]
        """
