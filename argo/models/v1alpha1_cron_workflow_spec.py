...
class V1alpha1CronWorkflowSpec(object):
    ...
    openapi_types = {
        ...
        'suspend': 'bool',
        'timezone': 'str',
        'workflow_meta': 'kubernetes.client.models.V1ObjectMeta',
    ...
    def __init__(self, concurrency_policy=None, failed_jobs_history_limit=None, schedule=None, starting_deadline_seconds=None, successful_jobs_history_limit=None, suspend=None, timezone=None, workflow_meta=None, workflow_spec=None, local_vars_configuration=None):  # noqa: E501
    ...
    def workflow_meta(self):
        ...
        :return: The workflow_meta of this V1alpha1CronWorkflowSpec.  # noqa: E501
    ...
    def workflow_meta(self, workflow_meta):
        """Sets the workflow_meta of this V1alpha1CronWorkflowSpec.


        :param workflow_meta: The workflow_meta of this V1alpha1CronWorkflowSpec.  # noqa: E501
