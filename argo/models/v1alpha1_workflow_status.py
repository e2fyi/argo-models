...
class V1alpha1WorkflowStatus(object):
    ...
    def __init__(self, compressed_nodes=None, finished_at=None, message=None, nodes=None, outputs=None, persistent_volume_claims=None, phase=None, started_at=None, stored_templates=None, local_vars_configuration=None):  # noqa: E501
