...
class V1alpha1WorkflowStatus(object):
    ...
    openapi_types = {
        ...
        'condition': 'list[V1alpha1Condition]',
    ...
    def __init__(self, compressed_nodes=None, condition=None, finished_at=None, message=None, nodes=None, offload_node_status_version=None, outputs=None, persistent_volume_claims=None, phase=None, started_at=None, stored_templates=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def condition(self):
        """Gets the condition of this V1alpha1WorkflowStatus.  # noqa: E501


        :return: The condition of this V1alpha1WorkflowStatus.  # noqa: E501
    ...
    def condition(self, condition):
        """Sets the condition of this V1alpha1WorkflowStatus.


        :param condition: The condition of this V1alpha1WorkflowStatus.  # noqa: E501
