...
class V1alpha1Artifact(object):
    ...
    def __init__(self, archive=None, archive_logs=None, artifactory=None, _from=None, git=None, global_name=None, http=None, mode=None, name=None, path=None, raw=None, s3=None):  # noqa: E501
